<!-- app/views/reportes/francisco-pineda.php -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Reporte de Ventas - Categoría Francisco Pineda</h1>
...
<div class="card mb-4">
    <div class="card-body">
        <form action="<?= BASE_URL ?>/reportes/francisco-pineda" method="get" class="row g-3 align-items-end">
            <div class="col-md-5">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Ventas - Categoría Francisco Pineda - <?= date('d/m/Y', strtotime($fecha_inicio)) ?> al <?= date('d/m/Y', strtotime($fecha_fin)) ?></h5>
...
<div id="print-content" style="display: none;">
    <div style="text-align: center; margin-bottom: 20px;">
        ...
        <h3>Reporte de Ventas - Categoría Francisco Pineda</h3>
