...
<div class="card">
    <div class="card-body">
        <form action="<?= BASE_URL ?>/rutas/store" method="post">
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="numero_ruta" class="form-label">Número de Ruta</label>
                    <input type="text" class="form-control" id="numero_ruta" name="numero_ruta" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="exclusivo_big_cola" name="exclusivo_big_cola" value="1">
