...
<body>
    ...
    <div class="dashboard-container">
        <div class="content-card">
            ...
            <div class="alert alert-info alert-custom">
                ...
                <strong>Importante:</strong> Las salidas se pueden registrar para <strong>HOY</strong> (<?php echo date('d/m/Y'); ?>) o <strong>MAÑANA</strong> (<?php echo date('d/m/Y', strtotime('+1 day')); ?>)
            </div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                ...
                const btnCancelar = document.querySelector('.btn-cancelar-salida');
                if (btnCancelar) {
            ...
            // Navegación rápida con teclado (para desktop)
            document.addEventListener('keydown', function(e) {
                ...
                if (e.key === 'Escape') {
                    const btnCancelar = document.querySelector('.btn-cancelar-salida');
                    if (btnCancelar && confirm('¿Desea cancelar y regresar al inicio? Los cambios no guardados se perderán.')) {
    ...
    <style>
        ...
        .tabla-productos-salida tbody tr:has(.input-cantidad:not([value=""]):not([value="0"])) {
