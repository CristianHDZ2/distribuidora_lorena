-- ***************************************************************
-- ** Se utiliza la base de datos que ya tienes creada. **
-- ***************************************************************
USE `if0_40169793_distribuidora_lorena`;

-- ----------------------------------------------------------------------
-- TABLA 1: usuarios (No tiene FKs, se crea primero)
-- ----------------------------------------------------------------------
...
-- Volcando datos para la tabla if0_40169793_distribuidora_lorena.usuarios: ~0 rows (aproximadamente)
...
-- ----------------------------------------------------------------------
-- TABLA 2: rutas (No tiene FKs, se crea antes de las que la referencian)
-- ----------------------------------------------------------------------
...
-- Volcando datos para la tabla if0_40169793_distribuidora_lorena.rutas: ~5 rows (aproximadamente)
...
-- ----------------------------------------------------------------------
-- TABLA 3: productos (No tiene FKs, se crea antes de las que la referencian)
-- ----------------------------------------------------------------------
...
-- Volcando datos para la tabla if0_40169793_distribuidora_lorena.productos: ~66 rows (aproximadamente)
...
-- ----------------------------------------------------------------------
-- TABLA 4: ajustes_precios (Depende de rutas, productos, usuarios)
-- ----------------------------------------------------------------------
...
-- ----------------------------------------------------------------------
-- TABLA 5: recargas (Depende de rutas, productos, usuarios)
-- ----------------------------------------------------------------------
...
-- ----------------------------------------------------------------------
-- TABLA 6: retornos (Depende de rutas, productos, usuarios)
-- ----------------------------------------------------------------------
...
-- Volcando datos para la tabla if0_40169793_distribuidora_lorena.retornos: ~27 rows (aproximadamente)
...
-- ----------------------------------------------------------------------
-- TABLA 7: salidas (Depende de rutas, productos, usuarios)
-- ----------------------------------------------------------------------
...
-- Volcando datos para la tabla if0_40169793_distribuidora_lorena.salidas: ~35 rows (aproximadamente)
